<template>
  ...
  <ol class="list-group list-group-numbered">
    <li class="list-group-item d-flex justify-content-between align-items-start" v-for="apothecary in apothecaryList" :key="apothecary.name">
...
export default {
  ...
  methods: {
    sortBy(prop) {
      this.apothecaryList.sort((a, b) => a[prop] < b[prop] ? -1 : 1)
    }
  },
