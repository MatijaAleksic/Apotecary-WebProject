<template>
    <div>
        ...
        <component v-on:refresh-component="refreshComponent" :patientINF ="{userId : this.userId, accessToken : this.accessToken}" v-bind:is="component"> </component>
    </div>
</template>

<script>

import ChangePersonalInformation from '@/components/Patient/ChangeInformationPatient.vue'
import ChangePatientPassword from '@/components/Patient/ChangePatientPassword.vue'
...
export default {
  ...
  'change-password' : ChangePatientPassword,
  },
  ...
  mounted() {
    ...
    axios.post("/api/patient/get-personal-info", {id : this.userId},
          {
            headers: {
