...
public class CustomUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		temp = administratorRepository.findByUsername(username);
		if(temp == null){
			temp = patientRepository.findByUsername(username);
			if(temp == null) {
				temp = pharmacistRepository.findByUsername(username);
				if (temp == null) {
					temp = dermatologistRepository.findByUsername(username);
				}
			}
		}
